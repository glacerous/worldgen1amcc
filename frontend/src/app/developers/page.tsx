          ...
          <div className="grid grid-cols-1 md:grid-cols-[240px_1fr] gap-10 items-start">
            ...
            <aside className="flex flex-row md:flex-col overflow-x-auto md:overflow-x-visible pb-4 md:pb-0 border-b md:border-b-0 md:border-r border-line/65 gap-1 md:gap-6 pr-0 md:pr-6 whitespace-nowrap">
              ...
              <div className="flex flex-row md:flex-col gap-1 md:gap-1.5 w-full md:pt-4 md:border-t md:border-line/45">
                ...
                <Link
                  href="/developers"
                  className="text-left px-3.5 py-2 text-xs md:text-sm font-sans rounded transition-all flex items-center justify-between bg-accent text-white font-semibold shadow-xs cursor-pointer w-full group"
                >
                      ...
                      <div className="space-y-5 animate-in fade-in duration-150">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="bg-ink/5 border border-line/65 rounded p-3 font-mono text-[11px] text-ink overflow-x-auto relative select-all">
                            <pre>{`curl -H "X-API-Key: ${currentDevKey}" \\\n  "https://worldgen1amcc.onrender.com/v1/public/buildings?limit=10&offset=0"`}</pre>
                          </div>
                        </div>
                    ...
                    {activeDocTab === "audit" && (
                      <div className="space-y-5 animate-in fade-in duration-150">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="bg-ink/5 border border-line/65 rounded p-3 font-mono text-[11px] text-ink overflow-x-auto relative select-all">
                            <pre>{`curl -H "X-API-Key: ${currentDevKey}" \\\n  "https://worldgen1amcc.onrender.com/v1/public/buildings/8374691d-b2fb-421f-ba6c-d5717adde2b6/audit"`}</pre>
                          </div>
                        </div>
                    ...
                    {activeDocTab === "tour" && (
                      <div className="space-y-5 animate-in fade-in duration-150">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="bg-ink/5 border border-line/65 rounded p-3 font-mono text-[11px] text-ink overflow-x-auto relative select-all">
                            <pre>{`curl -H "X-API-Key: ${currentDevKey}" \\\n  "https://worldgen1amcc.onrender.com/v1/public/buildings/8374691d-b2fb-421f-ba6c-d5717adde2b6/tour"`}</pre>
                          </div>
                        </div>
